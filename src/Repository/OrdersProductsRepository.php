...
class OrdersProductsRepository extends ServiceEntityRepository
{
	...
	public function findByIdField($orderid, $productid)
    {
        return $this->createQueryBuilder('o')
            ->andWhere('o.order_id = :oval')
			->andWhere('o.product_id = :prval')
            ->setParameter('oval', $orderid)
			->setParameter('prval', $productid)
            ->orderBy('o.id', 'ASC')
            //->setMaxResults(10)
            ->getQuery()
            ->getResult()
